 ...
 */
public class VistanominaController implements Initializable {
    ...
    public TableView<Movimiento> Tablamovnomina;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Tablamovnomina.setItems(comisiones); // Vincular la lista a la TableView
...
collsado.setCellFactory(new Callback<TableColumn<Movimiento, Double>, TableCell<Movimiento, Double>>() {
    ...
    private void buscarMovimientos(String searchText) {
        ...
        Tablamovnomina.setItems(filteredData);
    }
    ...
    private String calcularTotalGastos() {
        ...
        for (Movimiento movimiento : nomina) {
    ...
    public void ajustarAnchoColumnas() {
        ...
        for (TableColumn<Movimiento, ?> column : Tablamovnomina.getColumns()) {
            ...
            if (columnName.equals("Código")) {
                ...
                for (int i = 0; i < Tablamovnomina.getItems().size(); i++) {
    ...
    // Calcular totales
    double totalDebe = nomina.stream().mapToDouble(Movimiento::getDebe).sum();
    double totalHaber = nomina.stream().mapToDouble(Movimiento::getHaber).sum();
    double totalSaldo = nomina.stream().mapToDouble(Movimiento::getSaldo).sum();

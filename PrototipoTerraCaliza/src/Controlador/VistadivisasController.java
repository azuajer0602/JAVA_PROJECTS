 ...
 */
public class VistadivisasController implements Initializable {
    ...
    public TableView<Movimiento> Tablamovdivisas;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Tablamovdivisas.setItems(divisas); // Vincular la lista a la TableView
...
collsado.setCellFactory(new Callback<TableColumn<Movimiento, Double>, TableCell<Movimiento, Double>>() {
    ...
    private void buscarMovimientos(String searchText) {
        ...
        Tablamovdivisas.setItems(filteredData);
    }
    ...
    private String calcularTotalGastos() {
        ...
        for (Movimiento movimiento : divisas) {
    ...
    public void ajustarAnchoColumnas() {
        ...
        for (TableColumn<Movimiento, ?> column : Tablamovdivisas.getColumns()) {
            ...
            if (columnName.equals("Código")) {
                ...
                for (int i = 0; i < Tablamovdivisas.getItems().size(); i++) {
    ...
    // Calcular totales
    double totalDebe = divisas.stream().mapToDouble(Movimiento::getDebe).sum();
    double totalHaber = divisas.stream().mapToDouble(Movimiento::getHaber).sum();
    double totalSaldo = divisas.stream().mapToDouble(Movimiento::getSaldo).sum();

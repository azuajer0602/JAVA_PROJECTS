 ...
 */
public class VistacomisionesController implements Initializable {
    ...
    public TableView<Movimiento> Tablamovcomisiones;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Tablamovcomisiones.setItems(comisiones); // Vincular la lista a la TableView
...
collsado.setCellFactory(new Callback<TableColumn<Movimiento, Double>, TableCell<Movimiento, Double>>() {
    ...
    private void buscarMovimientos(String searchText) {
        ...
        Tablamovcomisiones.setItems(filteredData);
    }
    ...
    private String calcularTotalGastos() {
        ...
        for (Movimiento movimiento : comisiones) {
    ...
    public void ajustarAnchoColumnas() {
        ...
        for (TableColumn<Movimiento, ?> column : Tablamovcomisiones.getColumns()) {
            ...
            if (columnName.equals("Código")) {
                ...
                for (int i = 0; i <  Tablamovcomisiones.getItems().size(); i++) {
...
private void exportarAMovimientos() {
    ...
    // Calcular totales
    double totalDebe = comisiones.stream().mapToDouble(Movimiento::getDebe).sum();
    double totalHaber = comisiones.stream().mapToDouble(Movimiento::getHaber).sum();
    double totalSaldo = comisiones.stream().mapToDouble(Movimiento::getSaldo).sum();
